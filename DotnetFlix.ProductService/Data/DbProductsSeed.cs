    ...
    public static class DbProductsSeed
    {
        public static void Initialize(ProductsDbContext context)
        {
            ...
            var products = new List<Product>()
            {
                ...
                new Product { Name = "Bad Boys for Life",       Description = "Lorem ipsum dolor sit amet", Details = "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", Photo = @"https://image.tmdb.org/t/p/w1280/chhwNdkN4n2oIEjz736HPjTJg1h.jpg", Price = 99.95M, Quantity = 100 },
